...
namespace Launcher.App.KartSpec
{
    public class StartGameData
    {
        ...
        {
            Console.WriteLine("SpeedType: {0}, Kart_id: {1}, FlyingPet_id: {2}", StartTimeAttack_SpeedType, Kart_id, FlyingPet_id);
        ...
        public static void PrStartTimeAttack()
        {
            ...
            {
                oPacket.WriteInt(StartTimeAttack_Unk1);
                oPacket.WriteInt(0);
                GetKartSpac(oPacket);
                oPacket.WriteByte(0);
                oPacket.WriteInt(0);
                ...
                oPacket.WriteUInt(StartTimeAttack_Track);
        ...
        public static void GetKartSpac(OutPacket oPacket)
        {
            ...
            if (StartTimeAttack_SpeedType == 4 || StartTimeAttack_SpeedType == 6)
            {
            ...
            if (StartTimeAttack_SpeedType == 6)
            {
