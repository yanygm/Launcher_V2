...
namespace Launcher.Library.Encrypt
{
   ...
   //4C19A0 1.23516 ver
        ...
        private static unsafe Vector128<double> func_g(Vector128<double> _inxmm0)
        {
            ...
            // 存储向量低64位到内存
            Vector64<double> lower64 = xmm0.GetLower();
            *&temp_1 = lower64.GetElement(0);
            ...
            while (true)
            {
                ...
                // 处理移位操作
                xmm5 = Vector128.ShiftRightLogical(
                        xmm5.AsInt64(), 0x34)
.AsDouble(
                );

                // 提取元素
                int temp_ecx = xmm5.AsUInt16().GetElement(0);
                ...
                int temp_eax = xmm4.AsUInt16().GetElement(0);
                temp_eax &= 0x7F0;
        ...
        private static unsafe Vector128<double> LoadVector128LH(double* address)
        {
            ...
            else
            {
                ...
                output = output.WithUpper(highPart); // 替换高64位
            }
            return output;
        }
        ...
        private static unsafe Vector128<double> LoadVector128FromByteArray(byte[] arr, int index)
        {
            ...
            else
            {
                fixed (byte* address = arr)
                {
                    ...
                    return Vector128.Load(doubleAddress);
                }
            }
        }
